    ...
    return (
        <div className="bg-img">
            <div className="min-[1080px]:py-[9rem] max-[1080px]:pt-[9rem] max-[1080px]:pb-[2rem] min-[1080px]:pr-[5%] grid min-[1080px]:grid-cols-3 max-[1080px]:grid-row-2 gap-[4rem] ">
                ...
                <div className="col-span-1 min-[1080px]:relative max-[1080px]:flex max-[1080px]:justify-center max-sm:items-center max-[1080px]:px-[5rem] max-sm:px-4">
                    <div data-aos="fade-up" className=" min-[1080px]:absolute min-[1080px]:-bottom-24 rounded-[2rem] backdrop-blur-[5px] bg-[#f0f0f0cc] p-4 flex items-center flex-col gap-3">

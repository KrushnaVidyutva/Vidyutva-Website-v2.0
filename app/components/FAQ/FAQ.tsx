...
const FAQ = () => {
    ...
    return (
        <div className="px-[5%] pb-[7rem]" data-aos="fade-up" data-aos-offset="150" data-aos-duration="600">
            <div className="bg-[#009085] rounded-[1.5rem] px-[3.75rem] max-sm:px-[1.5rem] py-[6.25rem] min-[950px]:grid items-start min-[950px]:grid-cols-9 max-[950px]:flex max-[950px]:flex-col gap-[5rem]">
                <div className="min-[768px]:col-span-4 flex flex-col items-start gap-6 text-white">
                    <h2 className="font-semibold text-5xl max-sm:text-4xl">Got questions?</h2>
                    <p className="text-lg font-normal max-sm:text-sm">Thinking about getting into your first EV or maybe you manage a fleet of hundreds. You’ve got questions and we’ve got answers.</p>
                    <div className="flex items-end flex-wrap gap-4">
                        <Link to={"#"} className="flex justify-center items-center text-zinc-800 text-center px-6 py-3 gap-3 rounded-[3.125rem] border border-white bg-white hover:bg-[#00a181] hover:text-white transition-all duration-300 ease-out">
                            <div className="font-normal text-base pb-1 max-sm:text-sm">See all FAQs</div>

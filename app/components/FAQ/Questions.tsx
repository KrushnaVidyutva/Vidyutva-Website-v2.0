    ...
    return (
        <div className={`flex flex-col justify-center-center border-t border-green-50 py-5 cursor-pointer ${active ? "gap-5" : ""}`} onClick={() => setActive(!active)}>
            <div className="flex justify-between items-center">
                ...
                <div className="flex justify-center items-center rounded-full border border-white h-6 w-6">
                    <div className={`flex justify-center items-center w-[0.6rem] h-[0.6rem] pt-1 max-sm:pt-[.125rem] ${active ? "rotate-180 transition-all duration-500 ease-in-out" : "transition-all duration-500 ease-in-out"}`}>

            ...
            <div className="flex flex-col gap-[3rem]">
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="grid grid-cols-2 gap-8 max-sm:grid-cols-1">
                            <div className="col-span-1 flex flex-col gap-8" data-aos="fade-right" data-aos-duration="400">
                                <h1 className="font-semibold text-5xl max-sm:text-4xl">India’s reliable network</h1>
                                <p className="font-normal text-lg text-[#1d344f] max-sm:text-base">The Vidyutva platform brings together chargers operated by businesses and governments all over India, giving you access to the largest and fastest growing EV charging network - all in one place.</p>
                ...
                <div className="pt-[3rem] w-[100%] cn-main">
                    ...
                    <div className="cn-cards">
                        <div className="grid grid-rows-2 max-[860px]:grid-rows-1 gap-8 max-[860px]:justify-center">
